...
type AppScreen = 'loginSetup' | 'dashboard' | 'learnWords' | 'quiz' | 'allWords' | 'stats' | 'manageWords' | 'tutorChat' | 'gameSelection' | 'wordMatchGame' | 'typingPracticeGame' | 'speedQuizGame' | 'timedWordLinkGame' | 'gameResult';
...
const API_KEY = "AIzaSyCmXbdJtrVw-kf0HaFqNq2wmRGkoICeaSI";
if (API_KEY) {
    ai = new GoogleGenAI({ apiKey: API_KEY });
    console.log("Google Gemini API 키가 설정되었습니다. AI 기능이 활성화됩니다.");
} else {
    console.warn("API_KEY가 설정되지 않았습니다. AI 기능이 비활성화됩니다.");
}
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="border-t border-slate-200 dark:border-slate-700 pt-5 space-y-3">
                        ...
                        <div className="flex justify-end space-x-3">
                            ...
                            <button type="submit" className="px-4 py-2 bg-cyan-700 hover:bg-cyan-800 rounded text-white">저장</button>
                        </div>
                    </div>
                </form>
            </div>
                        ...
                        <button
                            ...
                            className={`flex flex-col sm:flex-row items-center justify-center p-1.5 sm:px-2.5 sm:py-1.5 rounded-md text-xs sm:text-sm font-medium transition-colors duration-150 ease-in-out
                                ${currentScreen === item.screen
                                    ? 'bg-cyan-600 text-white shadow-lg ring-2 ring-cyan-300 dark:ring-cyan-600'
        ...
        <div className="p-6 sm:p-8 bg-slate-100 dark:bg-slate-800 min-h-screen flex flex-col justify-center items-center">
            <div className="w-full max-w-md bg-white dark:bg-slate-700 p-8 rounded-xl shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        className="w-full py-3 px-4 bg-cyan-700 hover:bg-cyan-800 text-white font-semibold rounded-md shadow-md transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-opacity-75"
                    >
                        학습 시작
                    </button>
                </form>
         ...
         <li className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-700/50 rounded-md shadow-sm">
            ...
            {actionButton && !isAchieved ? (
                 <button 
                    ...
                    className="ml-2 px-2 py-1 text-xs bg-cyan-700 hover:bg-cyan-800 text-white rounded-md"
                >
                    {actionButton.label}
                </button>
            ) : (
        ...
        <div className="p-4 sm:p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4">
                 <button
                    ...
                    className="py-3 px-2 bg-cyan-700 hover:bg-cyan-800 text-white text-sm font-semibold rounded-lg shadow-md transition-colors duration-150 ease-in-out flex items-center justify-center"
                >
                    <span className="text-xl mr-2" aria-hidden="true">📖</span> 학습
                </button>
                 <button
                    onClick={() => onNavigate('quiz')}
                    className="py-3 px-2 bg-green-700 hover:bg-green-800 text-white text-sm font-semibold rounded-lg shadow-md transition-colors duration-150 ease-in-out flex items-center justify-center"
                >
                     <span className="text-xl mr-2" aria-hidden="true">📝</span> 퀴즈
                </button>
                 <button
                    onClick={() => onNavigate('gameSelection')}
                    className="py-3 px-2 bg-orange-700 hover:bg-orange-800 text-white text-sm font-semibold rounded-lg shadow-md transition-colors duration-150 ease-in-out flex items-center justify-center"
                >
                     <span className="text-xl mr-2" aria-hidden="true">🎮</span> 게임
                </button>
                 <button
                    onClick={() => onNavigate('tutorChat')}
                    className="py-3 px-2 bg-purple-700 hover:bg-purple-800 text-white text-sm font-semibold rounded-lg shadow-md transition-colors duration-150 ease-in-out flex items-center justify-center"
                >
            ...
            <div className="p-4 sm:p-8 flex flex-col items-center">
                ...
                <div className="w-full max-w-md bg-slate-100 dark:bg-slate-700 p-6 rounded-lg shadow-lg space-y-6">
                    ...
                    <button 
                        ...
                        className="w-full py-3 bg-cyan-700 hover:bg-cyan-800 text-white font-semibold rounded-md shadow-md"
                    >
                        학습 시작
                    </button>
                </div>
        ...
        <div className="p-4 sm:p-8 flex flex-col items-center">
            ...
            <div className="flex justify-between mt-6 w-full max-w-lg">
                ...
                <button
                    ...
                    className="w-1/2 ml-2 py-3 px-4 bg-green-700 hover:bg-green-800 text-white font-bold rounded-md shadow-lg transition-colors"
                >
        ...
        return (
            <div className="p-4 sm:p-8 flex flex-col items-center">
                ...
                <div className="w-full max-w-md bg-slate-100 dark:bg-slate-700 p-6 rounded-lg shadow-lg space-y-6">
                    ...
                    <button onClick={startQuiz} className="w-full py-3 bg-cyan-700 hover:bg-cyan-800 text-white font-semibold rounded-md shadow-md">
                        퀴즈 시작
                    </button>
                </div>
            </div>
            ...
            <div className="p-8 text-center">
                ...
                <div className="space-x-4">
                    <button
                        ...
                        className="py-3 px-6 bg-cyan-700 hover:bg-cyan-800 text-white font-semibold rounded-lg shadow-md"
                    >
                        다른 퀴즈 풀기
                    </button>
                    <button
            ...
            <div className="w-full max-w-xl bg-slate-100 dark:bg-slate-700 rounded-xl shadow-2xl p-6 sm:p-8">
                ...
                {quizType === 'multiple' ? (
                    <>
                                ...
                                <button
                                    ...
                                    className={`w-full p-3 sm:p-4 text-left rounded-lg shadow-md transition-all duration-150 ease-in-out
                                        ${showResult
                                            ...
                                            : 'bg-slate-200 dark:bg-slate-600 text-slate-800 dark:text-white hover:bg-cyan-700 dark:hover:bg-cyan-600 focus:outline-none focus:ring-2 focus:ring-cyan-400 dark:focus:ring-cyan-500 hover:text-white dark:hover:text-white'
                                        }`}
                                >
                                    {option}
                                </button>
                        ...
                        {showResult && (
                             <button
                                ...
                                className="w-full py-3 px-4 bg-cyan-700 hover:bg-cyan-800 text-white font-bold rounded-md shadow-lg"
                            >
                    ...
                    <form onSubmit={handleTypingSubmit}>
                        ...
                        <button type="submit" className="w-full mt-4 py-3 bg-cyan-700 hover:bg-cyan-800 text-white font-semibold rounded-md shadow-md">
            ...
            <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-xl w-full max-w-lg space-y-3 my-4 custom-scrollbar max-h-[90vh]">
                ...
                <div>
                 ...
                 <button
                    ...
                    className="w-full my-1 py-2 px-3 bg-sky-700 hover:bg-sky-800 text-white font-semibold rounded-md shadow-sm disabled:opacity-50 flex items-center justify-center text-sm"
                >
                ...
                <button
                    ...
                    className="w-full my-1 py-2 px-3 bg-purple-700 hover:bg-purple-800 text-white font-semibold rounded-md shadow-sm disabled:opacity-50 flex items-center justify-center text-sm"
                >
                ...
                <div className="flex justify-end space-x-3 pt-2">
                    <button type="button" onClick={onCancel} className="px-4 py-2 bg-slate-200 hover:bg-slate-300 dark:bg-slate-600 dark:hover:bg-slate-500 rounded text-slate-700 dark:text-white">취소</button>
                    {canEditFields && <button type="submit" className="px-4 py-2 bg-cyan-700 hover:bg-cyan-800 rounded text-white" disabled={isModalBusyWithActivity}>
            ...
            <div className="flex justify-between items-start">
                <div>
                    <h3 className={`text-xl font-semibold ${word.stat.isMastered ? 'text-green-600 dark:text-green-400' : 'text-cyan-700 dark:text-cyan-300'}`}>
                        {word.term} 
                        {word.stat.isMastered && <span className="text-xs bg-green-200 text-green-800 dark:bg-green-700 dark:text-green-100 px-1.5 py-0.5 rounded-full ml-2">완료</span>}
                        {word.isCustom && <span className="text-xs bg-yellow-200 text-yellow-800 dark:bg-yellow-700 dark:text-yellow-100 px-1.5 py-0.5 rounded-full ml-2">나의 단어</span>}
                        {word.unit && <span className="text-xs bg-blue-200 text-blue-800 dark:bg-blue-700 dark:text-blue-100 px-1.5 py-0.5 rounded-full ml-2">Unit {word.unit}</span>}
                    </h3>
                    <p className="text-sm text-slate-600 dark:text-slate-300">{word.partOfSpeech} - {word.meaning}</p>
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">학년: {gradeLabels[word.gradeLevel] || word.gradeLevel} | 복습: {word.stat.lastReviewed ? new Date(word.stat.lastReviewed).toLocaleDateString() : '안함'} | 오답: {word.stat.quizIncorrectCount}</p>
                </div>
                <div className="flex flex-col sm:flex-row space-y-1 sm:space-y-0 sm:space-x-1 flex-shrink-0 ml-2 items-end">
                    ...
                    <button 
                        ...
                        className={`p-1.5 rounded-md text-sm whitespace-nowrap ${word.stat.isMastered ? 'bg-slate-300 dark:bg-slate-600 text-slate-700 dark:text-slate-200 hover:bg-slate-400 dark:hover:bg-slate-500' : 'bg-green-700 hover:bg-green-800 text-white'}`}
...
const AllWordsScreen: React.FC = () => {
    ...
    const wordsToDisplay = useMemo(() => {
        console.log('allWords 길이:', allWords.length);
        ...
        console.log('필터링 후 단어 수:', filtered.length);
        return filtered;
...
const StatsScreen: React.FC = () => {
    ...
    const wordsByGrade = useMemo(() => {
        const counts: Record<string, number> = { elementary: 0, middle: 0, advanced: 0 };
        allWords.forEach(word => {
            if (counts.hasOwnProperty(word.gradeLevel)) {
                        ...
                        return (
                            <div key={grade} className="flex flex-col items-center flex-1">
                                <div 
                                    ...
                                    title={`${gradeLabels[grade] || grade}: ${count}개`}
                                ></div>
                                <p className="text-xs mt-1 text-slate-700 dark:text-slate-300">{gradeLabels[grade] || grade}</p>
                            </div>
                        );
                    })}
                </div>
...
const ManageWordsScreen: React.FC = () => {
    ...
    const canUseAI = API_KEY && !isCurrentlyGeminiQuotaExhausted;
    const aiButtonDisabledReason = !API_KEY ? "(API Key 필요)" : isCurrentlyGeminiQuotaExhausted ? "(Quota 소진)" : "";
        ...
        <div className="p-4 sm:p-6">
            ...
            <form onSubmit={handleAddWord} className="bg-slate-100 dark:bg-slate-700 p-6 rounded-lg shadow-lg space-y-4 mb-8">
                ...
                <button 
                    ...
                    className="w-full py-2 px-4 bg-sky-700 hover:bg-sky-800 text-white font-semibold rounded-md shadow-sm disabled:opacity-50 flex items-center justify-center"
                >
                    <span role="img" aria-label="ai" className="mr-2">✨</span> 
                ...
                <button 
                    ...
                    className="w-full py-2 px-4 bg-green-700 hover:bg-green-800 text-white font-semibold rounded-md shadow-sm disabled:opacity-50"
                >
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-80px)] p-4 sm:p-6 bg-slate-50 dark:bg-slate-900">
            ...
            <form onSubmit={handleSendMessage} className="mt-4 flex items-center space-x-2">
                ...
                <button
                    type="submit"
                    className="py-3 px-5 bg-cyan-700 hover:bg-cyan-800 text-white font-semibold rounded-lg shadow-md disabled:opacity-50"
        ...
        return (
            <div className="p-4 sm:p-8 flex flex-col items-center">
                ...
                <div className="w-full max-w-md bg-slate-100 dark:bg-slate-700 p-6 rounded-lg shadow-lg space-y-6">
                    ...
                    <button onClick={handleStartGame} className="w-full py-3 bg-cyan-700 hover:bg-cyan-800 text-white font-semibold rounded-md shadow-md">
                        게임 시작
                    </button>
                </div>
            </div>
                            ...
                            className={`p-3 sm:p-4 rounded-lg shadow-md text-sm sm:text-base text-center break-all min-h-[60px] flex items-center justify-center
                                ${matchedPairs.includes(opt.id)
                                    ...
                                    : (selectedTerm?.id === opt.id || selectedMeaning?.id === opt.id)
                                        ...
                                        : 'bg-slate-200 dark:bg-slate-600 text-slate-800 dark:text-white hover:bg-cyan-600 dark:hover:bg-cyan-500 hover:text-white'
                                }
        ...
        <div className="p-4 sm:p-6 flex flex-col items-center h-[calc(100vh-80px)]">
            ...
            <div className="mt-4">
                <button onClick={handleSubmit} disabled={gameState === 'finished'}
                        className="w-full max-w-md py-3 bg-green-700 hover:bg-green-800 text-white font-semibold rounded-md shadow-md disabled:opacity-50">
    ...
    return (
        <div className="p-4 sm:p-8 text-center flex flex-col items-center justify-center min-h-[calc(100vh-150px)] sm:min-h-0">
            ...
            <div className="mt-8 space-x-4">
                <button
                    onClick={() => onNavigate('gameSelection')}
                    className="py-2 px-6 bg-cyan-700 hover:bg-cyan-800 text-white font-semibold rounded-lg shadow-md"
                >
                    다른 게임하기
                </button>
                <button
        ...
        return (
            <div className="p-4 sm:p-8 flex flex-col items-center justify-center min-h-[calc(100vh-150px)] sm:min-h-0">
                ...
                <div className="w-full max-w-md bg-slate-100 dark:bg-slate-700 p-6 rounded-lg shadow-lg space-y-6">
                    ...
                    <button onClick={startGame} className="w-full py-3 bg-cyan-700 hover:bg-cyan-800 text-white font-semibold rounded-md shadow-md">
                        게임 시작!
                    </button>
                </div>
            </div>
    ...
    return (
        <div className={`p-4 sm:p-6 flex flex-col items-center transition-colors duration-300 min-h-[calc(100vh-100px)] justify-center ${feedback === 'correct' ? 'bg-green-100 dark:bg-green-800/30' : feedback === 'incorrect' ? 'bg-red-100 dark:bg-red-800/30' : ''}`}>
            <div className="w-full max-w-2xl">
                ...
                <div className="bg-slate-100 dark:bg-slate-700 p-8 rounded-xl shadow-2xl text-center">
                    <p className="text-4xl sm:text-5xl font-bold text-slate-800 dark:text-white mb-8">{currentWord.term}</p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {options.map((option, index) => (
                            <button
                                ...
                                className="p-4 rounded-lg shadow-md bg-slate-200 dark:bg-slate-600 text-slate-800 dark:text-white hover:bg-cyan-600 dark:hover:bg-cyan-500 hover:text-white disabled:opacity-75 transition-colors"
                            >
                                {option}
                            </button>
                        ))}
...
// --- App Component ---
const App: React.FC = () => {
    const { userSettings, appScreen, onNavigate, routeParams, isSettingsModalOpen, handleOpenSettings, handleCloseSettings, memoizedStats } = useAppContext();
    ...
    const renderScreen = () => {
        switch (appScreen) {
            case 'loginSetup': return <LoginSetupScreen onSetupComplete={() => {}} />; // This is handled in provider now
            case 'dashboard': return <DashboardScreen {...memoizedStats} />;
            case 'learnWords': return <LearnWordsScreen routeParams={routeParams}/>;
            case 'quiz': return <QuizScreen routeParams={routeParams}/>;
            case 'allWords': return <AllWordsScreen />;
            case 'stats': return <StatsScreen />;
            case 'manageWords': return <ManageWordsScreen />;
            case 'tutorChat': return <TutorChatScreen />;
            case 'gameSelection': return <GameSelectionScreen />;
            case 'gameResult': return <GameResultScreen routeParams={routeParams} />;
            case 'wordMatchGame': return <WordMatchGame />;
            case 'typingPracticeGame': return <TypingPracticeGame />;
            case 'speedQuizGame': return <SpeedQuizGame />;
            case 'timedWordLinkGame': return <TimedWordLinkGame />;
            default: return <DashboardScreen {...memoizedStats} />;
        }
    };

    return (
        <div className={`theme-${userSettings.theme} bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-50 min-h-screen transition-colors duration-300`}>
            {appScreen !== 'loginSetup' && <NavBar currentScreen={appScreen} onOpenSettings={handleOpenSettings} />}
            <main>
                {renderScreen()}
            </main>
...
const AppProvider: React.FC = () => {
    ...
    useEffect(() => {
        try {
            ...
            if (savedSettings) {
                ...
                // Migration for user's grade level
                if (['middle1', 'middle2', 'middle3', 'high'].includes(parsedSettings.grade)) {
                    parsedSettings.grade = 'middle';
                }
            ...
            // 3000개 단어를 강제로 로드하기 위해 localStorage 초기화
            localStorage.removeItem('allWords');
            localStorage.removeItem('wordStats');
            
            // Migration for word grade levels
            const migratedWords = sampleWords.map((word: Word) => {
                 if (['middle1', 'middle2', 'middle3', 'high'].includes(word.gradeLevel)) {
                    return { ...word, gradeLevel: 'middle' };
                }
                return word;
            });

            setAllWords(migratedWords);
            console.log('로드된 단어 수:', migratedWords.length);
            ...
            addToast("데이터 로딩 중 오류가 발생했습니다. 데이터를 초기화할 수 있습니다.", "error");
    ...
    const handleResetData = () => {
        ...
        setWordStats({});
        setAppScreen('loginSetup');
        addToast("모든 데이터가 초기화되었습니다.", "warning");
    };

    const onNavigate = (screen: AppScreen, params: any = null) => {
        setAppScreen(screen);
    ...
    const updateWordStat = (wordId: string | number, updates: Partial<WordStat>) => {
        setWordStats(prev => {
            const currentStat = prev[wordId] || getDefaultWordStat(wordId);
            return {
                ...prev,
                [wordId]: { ...currentStat, ...updates }
            };
        });
    };
    ...
    const handleWordLearned = (wordId: string | number) => {
        ...
        if (userSettings && userSettings.lastLearnedDate !== today) {
            ...
            const lastLearnedIsYesterday = userSettings.lastLearnedDate === yesterday.toISOString().split('T')[0];
            const newStreak = lastLearnedIsYesterday ? (userSettings.currentStreak || 0) + 1 : 1;
        ...
        } else if (userSettings && userSettings.lastLearnedDate === undefined) {
             setUserSettings(prev => prev ? { ...prev, lastLearnedDate: today, currentStreak: 1, bestStreak: 1 } : null);
        }
    };
    
    const handleQuizComplete = (score: number, total: number, incorrectWords: Word[]) => {
        const today = getTodayDateString();
        const xpGained = Math.round((score / Math.max(1, total)) * 25) + score;
        addXp(xpGained);
        addToast(`퀴즈 완료! ${xpGained} XP를 획득했습니다.`, "success");
        setUserSettings(prev => prev ? { ...prev, lastQuizDate: today, lastQuizScore: (score/total)*100 } : null);
    };

    const handleGameComplete = (score: number, correct: number, incorrect: number, timeTaken: number) => {
        const today = getTodayDateString();
        addXp(score);
        setUserSettings(prev => prev ? { ...prev, lastGameDate: today } : null);
    };
    
    const addXp = (amount: number) => {
        if (!userSettings) return;
        const newXp = (userSettings.xp || 0) + amount;
        let newLevel = userSettings.level || 1;
        ...
        setUserSettings(prev => prev ? { ...prev, xp: newXp, level: newLevel } : null);
    };
    ...
    const handleSaveCustomWord = async (word: Partial<Word>, gradeLevel?: string, unit?: number): Promise<{ success: boolean, reason?: string }> => {
        if (!word.term?.trim()) return { success: false, reason: "단어는 비워둘 수 없습니다." };
        
        const existingWord = allWords.find(w => w.term.toLowerCase() === word.term?.toLowerCase().trim() && w.id !== word.id);
        if (existingWord) {
        ...
        if (word.id) { // Existing word
             wordToSave = { ...word, term: word.term.trim(), gradeLevel: gradeLevel || 'middle', isCustom: true } as Word;
             setAllWords(prev => prev.map(w => w.id === word.id ? wordToSave : w));
        } else { // New word
            wordToSave = { 
                ...word,
             ...
             setAllWords(prev => [...prev, wordToSave]);
        }
        return { success: true };
    };
    ...
    const memoizedStats = useMemo(() => {
        if (!userSettings) {
            return { learnedWordsToday: 0, totalWordsLearned: 0, learningStreak: { currentStreak: 0, bestStreak: 0 }, averageQuizScore: 0, quizTakenToday: false, gamePlayedToday: false, hasIncorrectWordsToReview: false };
        }
        const today = getTodayDateString();
        
        const learnedTodayCount = Object.values(wordStats).filter(stat => stat.lastReviewed === today).length;
        const totalLearnedCount = Object.keys(wordStats).length;

        const allQuizScores = Object.values(userSettings)
            .filter(v => typeof v === 'number' && v <= 100); // Simplistic check; better if scores stored in array
        const avgScore = userSettings.lastQuizScore !== undefined ? userSettings.lastQuizScore : 0;
        ...
        return {
            learnedWordsToday: learnedTodayCount,
            totalWordsLearned: totalLearnedCount,
            learningStreak: { currentStreak: userSettings.currentStreak || 0, bestStreak: userSettings.bestStreak || 0 },
            averageQuizScore: avgScore,
            quizTakenToday,
            gamePlayedToday,
            hasIncorrectWordsToReview
        };
    }, [userSettings, wordStats]);


    if (!userSettings) {
        return (
            <LoginSetupScreen onSetupComplete={(settings) => {
